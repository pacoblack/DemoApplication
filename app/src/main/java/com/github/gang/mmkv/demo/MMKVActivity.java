...
import com.github.gang.mmkv.NativeBuffer;

import java.util.Arrays;
import java.util.HashSet;
import java.util.LinkedHashSet;

import static com.github.gang.mmkv.demo.BenchMarkBaseService.AshmemMMKV_ID;
import static com.github.gang.mmkv.demo.BenchMarkBaseService.AshmemMMKV_Size;
...
public class MMKVActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MMKV kv = testMMKV("test/AES", "Demo MMKV", false, otherDir);
        if (kv != null) {
