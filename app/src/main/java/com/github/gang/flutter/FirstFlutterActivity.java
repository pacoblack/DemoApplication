...
import com.github.gang.SecondActivity;
...
//TODO:并没有走通这个Activity,这里对应的是 ${_widgetForRoute}
public class FirstFlutterActivity extends AppCompatActivity {
    public static void startActivity(Activity activity){
        Intent intent = new Intent(activity, FirstFlutterActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FrameLayout.LayoutParams lp = new FrameLayout.LayoutParams(
                ...
                ViewGroup.LayoutParams.MATCH_PARENT);
        FrameLayout flContainer = findViewById(R.id.layout_root);
            ...
            public void onMethodCall(MethodCall call, MethodChannel.Result result) {
                switch (call.method){
                    case "openSecondNative":
                        // 跳转原生页面
                        Intent jumpToNativeIntent = new Intent(FirstFlutterActivity.this, SecondActivity.class);
